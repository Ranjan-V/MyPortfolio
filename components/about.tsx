  ...
  return (
    ...
    >
      ...
      <p className="mb-3">
        ...
        <span className="font-medium"> I’ve worked extensively with languages like  Python, Java, C++ and SQL and I enjoy building meaningful solutions using modern technologies and tools.</span>{" "}
      ...
      <p>
        <span className="italic">Beyond coding, I love playing chess and badminton. I also run two YouTube channels — one dedicated to teaching coding and the other focused on chess content.</span> It's my way of sharing what I love and staying connected with a broader community.{" "}
